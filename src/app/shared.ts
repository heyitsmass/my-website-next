...
export const skills = {
	...
	// Mobile Development
	mobileDevelopment: [
		{ name: 'React Native', icon: SiReactHex },
	...
	thirdPartyIntegrations: [
		...
		{ name: 'Slack API', icon: SiSlackHex },
		{ name: 'Discord API', icon: SiDiscordHex },
		{ name: 'XGen API', icon: undefined },
		{ name: 'Salesforce', icon: SiSalesforceHex },
		{ name: 'Shopify', icon: SiShopifyHex },
		{ name: 'PayPal', icon: SiPaypalHex },
		{ name: 'Facebook API', icon: SiFacebookHex },
	],
	...
	designAndCollaboration: {
		...
		projectManagement: [
			...
			{ name: 'GitHub Projects', icon: SiGithubHex },
			{ name: 'GitLab Boards', icon: SiGitlabHex },
